...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/sikh-social/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/sikh-social/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://www.sikh.social/assets/images/profile-cover.png',
          site: 'https://www.sikh.social/',
          url: 'https://www.sikh.social' + params,
        ...
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://www.sikh.social/assets/images/profile-cover.png',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
          ...
          const talent = {
            name: `Sikh Social Research ${group?.PageTitle}`,
